...
Corus Facilitator v0.1 is the YAML-first version of the facilitator.
...
This version moves the center of gravity from command prompts to object shapes.
...
3. Provide meeting notes, transcripts, email threads, Slack threads, or other source material.
4. Ask for YAML output only.
